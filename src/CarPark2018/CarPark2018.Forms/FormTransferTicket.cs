...
public class FormTransferTicket : Form
{
	...
	private CheckBox checkIsNoFeel;

	public string LicensePlate { get; set; }

	public FormTransferTicket()
	{
		...
		InitializeComponent();
		base.Load += FormTransferTicket_Load;
		try
		{
	...
	private void LangManager_LanguageChangedEvent(SysLanguage currentLang)
	{
		...
		rbQPASS.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.rbQPASS");
		rbAirPay.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.rbAirPay");
		labArea.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.labArea");
		labChargeTime.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.labChargeTime");
		...
		labQRCode.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.labQRCode");
		...
		btnOther.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.btnOther");
	}
	...
	{
		m_ChargeRecord.BillType = 14;
		m_ChargeRecord.CardCode = m_ChargeRecord.CardCode;
	...
	private void CalcAmount()
	{
		try
		{
			if (m_TransactionData != null)
			{
				...
				EnumBillType billType = EnumBillType.ElectronicPaymentConversion;
				...
				if (calcTicketFeeReturn.ISValid)
				{
					if (!calcTicketFeeReturn.HasLastTimeCharge)
					{
						...
						FormFee.Self().SetTicket(txtInTime.Text, txtChargeTime.Text, $"{txtParkHour.Text}小時{txtParkMin.Text}分", txtTotalCharge.Text);
					}
					else if (calcTicketFeeReturn.ISTimeOut)
					{
						Global.ShowMessage(LangManager.GetLangString("CarPark.Forms.ShowMessage.ChargeTimeOut"));
						((IFeeCenterV3)DeviceManager.FeeCenterModule).QRCodeScanEvent -= FormTimeChargeLost_QRCodeScanEvent;
					...
					else
					{
						...
						FormFee.Self().SetTicket(txtInTime.Text, txtChargeTime.Text, $"{txtParkHour.Text}小時{txtParkMin.Text}分", txtTotalCharge.Text);
						Global.ShowMessage(LangManager.GetLangString("CarPark.Forms.ShowMessage.ChargeNoTimeOut"));
					}
					btnOK.Enabled = true;
	...
	private void txtTicketNo_TextChanged(object sender, EventArgs e)
	{
		try
		{
			...
			if (rbMPASS.Checked)
			{
				...
				{
					Global.ShowMessage(LangManager.GetLangString("CarPark.Forms.ShowMessage.NoRecord"));
				}
			}
			else if (rbQPASS.Checked)
			{
				...
				list = new List<view_transactionandlp>();
				getView_TransactionAndLPArgs.QPassNumber = txtTicketNo.Text;
				ChargeContext obj = new ChargeContext();
				obj.CommunicationChannel.GetView_TransactionAndLP(getView_TransactionAndLPArgs, out list);
			...
			else
			{
				...
				if (checkIsNoFeel.Checked)
				{
					getView_TransactionAndLPArgs.Extend1 = "nofeel";
				}
				...
				if (list.Count > 0)
				{
					using (List<view_transactionandlp>.Enumerator enumerator3 = list.GetEnumerator())
					{
						if (enumerator3.MoveNext())
						{
							view_transactionandlp current3 = enumerator3.Current;
							view = current3;
						}
					}
					DisableRB();
	...
	private void rbMPASS_CheckedChanged(object sender, EventArgs e)
	{
		...
		{
			labTicketNo.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.labTicketNo");
			label1.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.label2");
		}
		else
		{
			labTicketNo.Text = LangManager.GetLangString("CarPark.Forms.FormTransferTicket.labTicketNo2");
	...
	private void InitializeComponent()
	{
		...
		this.rbQPASS = new System.Windows.Forms.RadioButton();
		...
		this.checkIsNoFeel = new System.Windows.Forms.CheckBox();
		...
		this.panel2.Controls.Add(this.checkIsNoFeel);
		this.panel2.Controls.Add(this.rbAirPay);
		this.panel2.Controls.Add(this.label1);
		this.panel2.Controls.Add(this.rbQPASS);
		...
		this.rbAirPay.Location = new System.Drawing.Point(493, 50);
		...
		this.rbQPASS.Enabled = false;
		this.rbQPASS.Font = new System.Drawing.Font("微软雅黑", 10f);
		this.rbQPASS.Location = new System.Drawing.Point(493, 25);
		this.rbQPASS.Name = "rbQPASS";
		this.rbQPASS.Size = new System.Drawing.Size(83, 24);
		this.rbQPASS.TabIndex = 0;
		this.rbQPASS.Text = "銀聯閃付";
		this.rbQPASS.UseVisualStyleBackColor = true;
		this.rbQPASS.CheckedChanged += new System.EventHandler(rbMPASS_CheckedChanged);
		this.rbMPASS.Enabled = false;
		...
		this.btnFree.Location = new System.Drawing.Point(445, 269);
		...
		this.txtTotalCharge.Location = new System.Drawing.Point(248, 481);
		...
		this.comboParkArea.Location = new System.Drawing.Point(248, 430);
		...
		this.comboParkType.Location = new System.Drawing.Point(248, 377);
		...
		this.txtFree.Location = new System.Drawing.Point(248, 270);
		...
		this.txtParkMin.Location = new System.Drawing.Point(445, 217);
		...
		this.txtParkHour.Location = new System.Drawing.Point(248, 217);
		...
		this.txtChargeTime.Location = new System.Drawing.Point(248, 163);
		...
		this.txtInTime.Location = new System.Drawing.Point(248, 110);
		...
		this.labArea.Location = new System.Drawing.Point(14, 433);
		...
		this.labTotalCharge.Location = new System.Drawing.Point(14, 481);
		...
		this.labParkType.Location = new System.Drawing.Point(14, 380);
		...
		this.labFreeTime.Location = new System.Drawing.Point(14, 274);
		...
		this.labTimeSplit.Location = new System.Drawing.Point(391, 221);
		...
		this.labParkTime.Location = new System.Drawing.Point(14, 221);
		...
		this.labChargeTime.Location = new System.Drawing.Point(14, 167);
		...
		this.labLastTime.Location = new System.Drawing.Point(14, 114);
		...
		this.checkIsNoFeel.AutoSize = true;
		this.checkIsNoFeel.Checked = true;
		this.checkIsNoFeel.CheckState = System.Windows.Forms.CheckState.Checked;
		this.checkIsNoFeel.Font = new System.Drawing.Font("微软雅黑", 10f);
		this.checkIsNoFeel.Location = new System.Drawing.Point(492, 78);
		this.checkIsNoFeel.Name = "checkIsNoFeel";
		this.checkIsNoFeel.Size = new System.Drawing.Size(84, 24);
		this.checkIsNoFeel.TabIndex = 5;
		this.checkIsNoFeel.Text = "收費校驗";
		this.checkIsNoFeel.UseVisualStyleBackColor = true;
	...
	private void FormTransferTicket_Load(object sender, EventArgs e)
	{
	...
	private void ManualOpenGate()
	{
		try
		{
			ManualUpBarArgs manualUpBarArgs = new ManualUpBarArgs(Settings.Default.OnlyID)
			{
				...
				Extend1 = (LicensePlate?.ToUpper().Trim() ?? LicensePlate)
			};
