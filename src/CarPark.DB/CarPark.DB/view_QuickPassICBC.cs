...
[EdmEntityType(NamespaceName = "CarPark.DB", Name = "view_QuickPassICBC")]
public class view_QuickPassICBC : EntityObject
{
	...
	public static view_QuickPassICBC Createview_QuickPassICBC(int transactionID, decimal cardBillAmount, int shiftID, bool iSUploaded, DateTime transactionTime)
	{
		view_QuickPassICBC view_QuickPassICBC2 = new view_QuickPassICBC();
		view_QuickPassICBC2.TransactionID = transactionID;
		view_QuickPassICBC2.CardBillAmount = cardBillAmount;
		view_QuickPassICBC2.ShiftID = shiftID;
		view_QuickPassICBC2.ISUploaded = iSUploaded;
		view_QuickPassICBC2.TransactionTime = transactionTime;
		return view_QuickPassICBC2;
	}
}
